	...
	var pluginMethods	= {
		...
		/*	Here we load all of the blog posts to the index. 
			...
			var index 		= this.index,
				...
				obj			= {limit: "all",  include: "tags, author"};
			...
			$.get(ghost.url.api('posts',obj)).done(function(data){
				...
				searchData.forEach(function(arrayItem){
					...
					blogData[arrayItem.id] = {title: arrayItem.title, description: arrayItem.meta_description,
											  pubDate: tempdate, link: arrayItem.url, tag: category, image: arrayItem.image,
											  authorName: arrayItem.author.name, authorLink: arrayItem.author.slug };
				});
			});
			this.isInit = true;
		},
