...
$(document).ready(function () {
  ...
  function insertPost(postData, authorData, animate) {
    ...
    var postInfo = '<div class="masonry-item animated fadeIn" style="animation-delay:' + animate + 's">';
    ...
    postInfo += '<div class="masonry-post__content">' +
      ...
      '<h6 class="post-author">by <a href="' + authorData.url + '">' + authorData.name +  '</a></h6>' +
			'<p class="post-tags">' + listTags(postData.tags) + '</p>' +
      '<p>' + excerpt + '</p>' +
